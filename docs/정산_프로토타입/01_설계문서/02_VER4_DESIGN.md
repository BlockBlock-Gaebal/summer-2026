...
> 첨부 그래프(`04_그래프/v4_*.png`)는 α=0.3 시점 산출물이라 본문 수치와 소수점이 다르다 — 곡선의 부호·형태·순위는 동일하다.
...
|---|---|---|---|---|---|---|---|
| I 개방형 | 7.189 | 5.238 | 0.758 | 0.2396 | 0.3273 | **0.3792** | **$g=29$ (우상향)** |
...
합류자 없는 기준선 19.410 대비, day 15 합류 시 기존 완주자의 기대 수령: I **17.607** (−1.803, 희석 최대) / III 18.779 (프리미엄이 대부분 보상) / II 19.085 (잔여 희석은 신규 스트림 공유분 — 합류자도 위험 풀에 서므로 정당한 몫이다).
