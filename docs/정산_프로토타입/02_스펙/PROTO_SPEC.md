...
> 🗂 **아카이브 — 2026-07-17 작성 · 2026-08-06 v3 시점의 구현 스펙.**
> ver1~4는 구현이 끝났고(`sui move test` 25개 통과 · Testnet 배포 · 온체인 검증 완료),
> 본문에 남은 "PLACEHOLDER 커브" 서술은 D-05(커브 입력 `k = d − 1`)·D-06(α = 0.2)으로 이미 확정됐다.
